...
savepath = "/home/gy237/project/llama3/unsloth/ig/finetuned_model"
...
## 加载数据集
train_file = "/home/gy237/project/llama3/unsloth/ig/data/train.json"
train_data = load_dataset("json", data_files = {"train" : train_file}, split = "train")

eval_file = "/home/gy237/project/llama3/unsloth/ig/data/dev.json"
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(    # one day 58250 steps
        ...
        seed = 42,
        output_dir = "/home/gy237/project/llama3/unsloth/ig/output",
    ),
)
