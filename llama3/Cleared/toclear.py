...
for i in ['train', 'dev']:
# 打开并读取文本文件
    with open(f'/home/s211505003/iGEM2/fine_tune/data/AdvertiseGen_/{i}.json', 'r', encoding='utf-8') as file:
        text = file.read()
    ...
    # 将清理后的文本保存回文件
    with open(f'/home/s211505003/iGEM2/fine_tune/data/Cleared/{i}.json', 'w', encoding='utf-8') as file:
        file.write(text)
