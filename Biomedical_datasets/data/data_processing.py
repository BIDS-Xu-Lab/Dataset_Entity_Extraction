...
for i in train_id:
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.ann', train_folder)
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.txt', train_folder)

test_folder = '/home/gy237/project/Biomedical_datasets/data/test_data'
for i in test_id:
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.ann', test_folder)
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.txt', test_folder)

devel_folder = '/home/gy237/project/Biomedical_datasets/data/devel_data'
for i in devel_id:
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.ann', devel_folder)
    shutil.copy(f'/home/gy237/project/Biomedical_datasets/data/row_data/{i}.txt', devel_folder)
