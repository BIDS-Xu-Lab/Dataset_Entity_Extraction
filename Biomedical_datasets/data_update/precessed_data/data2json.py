...
#     _id = 'PMC7094943'  #'PMC7228217'
    ...
    for _ent in entities:
        if _ent["name"] != text[_ent["start"]: _ent["end"]]:
            print(_ent["name"])
            print(text[_ent["start"]: _ent["end"]])  # PMC7471802, PMC7366180, PMC7441778, PMC7252096, PMC7354438
    ...
    if len(text_list) != 2*len(entities)+1 or len(bool_list) != len(text_list):    # check the number
        print(_id)
...
with open(f'/home/gy237/project/Biomedical_datasets/data_update/precessed_data/{_type}_data.json', 'w', encoding='utf-8') as file:
