...
#     _id = 'PMC7094943'  #'PMC7228217'
    entities, relations = parse_ann_file(f'/home/gy237/project/Biomedical_datasets/data/{_type}_data/{_id}.ann')
    
    with open(f'/home/gy237/project/Biomedical_datasets/data/{_type}_data/{_id}.txt', 'r', encoding='utf-8') as f:
        text = f.read()
