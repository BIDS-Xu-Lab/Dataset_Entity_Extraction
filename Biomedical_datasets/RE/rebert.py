...
from transformers import BertTokenizer, BertForSequenceClassification, AdamW, BertConfig, BertTokenizerFast
...
path = f'/home/gy237/project/Biomedical_datasets/RE/{_name}_output'
...
def add_t(sen, lab, rel):
    ...
    for i in range(len(sen)):
        ...
        entities_s = [j['id'] for j in lab[i] if j and j['type'] in ['Dataset', 'Repository', 'Creator']]
        entities_e = [j['id'] for j in lab[i] if j and j['type'] in ['URL', 'AccessionNumber', 'DOI']]
