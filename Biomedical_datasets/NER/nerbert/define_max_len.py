...
# load data
csv_reader = csv.reader(open("/home/gy237/project/Biomedical_datasets/NER/data/train_data.csv"))
train = pd.DataFrame(csv_reader, columns=['word', 'label'])

csv_reader = csv.reader(open("/home/gy237/project/Biomedical_datasets/NER/data/test_data.csv"))
