...
# load data
csv_reader = csv.reader(open("/home/gy237/project/Biomedical_datasets/NER/data_updated/train_data_updated.csv"))
train = pd.DataFrame(csv_reader, columns=['word', 'label'])

csv_reader = csv.reader(open("/home/gy237/project/Biomedical_datasets/NER/data_updated/test_data_updated.csv"))
    ...
    for word, label in zip(sentence, text_labels):
        ...
        if n_subwords > 1:
            if label.startswith('S-'):
                ...
                _labels = [f'B-{_label}'] + [f'I-{_label}']*(n_subwords - 2) + [f'E-{_label}']
...
tr_inputs, tr_tags, tr_masks= shuffle(train_input_ids, train_tags, train_attention_masks, random_state=42)
val_inputs, val_tags, val_masks = shuffle(test_input_ids, test_tags, test_attention_masks, random_state=42)
