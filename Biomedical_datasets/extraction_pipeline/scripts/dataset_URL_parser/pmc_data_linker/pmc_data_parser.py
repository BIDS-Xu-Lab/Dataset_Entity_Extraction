...
def parse_das_sec(pmc_file_path):
    ...
    das_sec = {"das_title": das_title, "das_statement": das_statement, "das_links": das_links}
    return das_sec
...
if __name__ == "__main__":
    ...
    for i, pmc_file in enumerate(current_filelist):
        ...
        pmc = PMCDataElement(pmc_meta['pmid'], pmc_meta['pmc'], pmc_meta['full_title'], pmc_meta['abstract'], das_sec, refs, in_text_urls)
