...
for name in all_items:
    ...
    for pmcid in pmcids:
        try:
            with open(f'/home/gy237/project/Biomedical_datasets/extraction_pipeline/key_word/{name}/{pmcid}.json', 'r', encoding = 'utf-8') as f:
                paper = json.load(f)
                assert len(paper)==1
                paper = paper[0]
                papers.append(paper)
            ...
            for i in range(len(passages)):
                ...
                if 'suppl' in passage_type.lower() and 'data availability' in passages[i-1]['text'].lower():
                    corpus.append(passage_text)
    ...
    with open(f'/home/gy237/project/Biomedical_datasets/extraction_pipeline/key_word/{name}.tsv', 'w', newline='') as file:
...
with open('/home/gy237/project/Biomedical_datasets/extraction_pipeline/key_word/test.json', 'w', encoding='utf-8') as f:
